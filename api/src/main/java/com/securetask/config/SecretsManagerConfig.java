...
public class SecretsManagerConfig {
    ...
    @Bean("jwtSecret")
    @ConditionalOnMissingBean(name = "jwtSecret")
    public String jwtSecret(SecretsManagerClient client) throws Exception {
        ...
        JsonNode secret = mapper.readTree(resp.secretString());
        return secret.get("secret").asText();
    }
